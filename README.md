...
- 10000 epochs
- test accuracy: 88.33%
- confusion matrix: ![](https://github.com/Embra-Schuilenburg/Neural-Network-For-Heart-Disease-Prediction/blob/master/images/firstIteration%20confusion%20matrix)
## AI usage summary
